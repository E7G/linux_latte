...
static const struct property_entry xiaomi_mipad2_props[] = {
	...
	/*
	 * The original Xiaomi battery profile is a 6190 mAh high-voltage pack
	 * with a 4.400 V fast/maintenance charge voltage and 256 mA
	 * termination current.  Firmware leaves VREG at only 4.208 V, which
	 * can terminate charging well before the BQ27520 gauge reaches full.
